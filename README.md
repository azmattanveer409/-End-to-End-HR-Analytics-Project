...
- Build analytical workflows using Python, SQL, and Power BI
...
To improve analytical insights and prepare the dataset for advanced analytics and machine learning workflows.
...
Uploaded the cleaned dataset into MySQL and solved multiple business-oriented HR questions using SQL queries.
